...
struct TemplateOverload: View {
                                        ...
                                        Group {
                                            ...
                                            if exercise.resistance.usesWeight,
                                               ...
                                               prevW != set.weight.displayValue {
                                                HStack(spacing: 2) {
                                                    Text(Format.smartFormat(prevW)).foregroundStyle(.gray)
                                                    Text("→")
                                                    weightText(set.weight, true)
    ...
    private func weightText(_ w: Mass, _ usesWeight: Bool) -> Text {
        usesWeight ? w.formattedText() : Text("Body-weight")
    }
                                        ...
                                        Group {
                                            ...
                                            if let prevLoad = prevSet?.load,
                                               prevLoad != set.load {
                                                ...
                                                //loadText(set.load, exercise.resistance.usesWeight)
                                                set.load.formattedText
                                            }
